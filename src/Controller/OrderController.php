...
class OrderController extends AbstractController
{
    ...
    public function __construct(AddVehicleToOrderUseCase $addVehicleToOrderUseCase, AddInsuranceToOrderUseCase $addInsuranceToOrderUseCase, AddPaymentMethodToOrderUseCase $addPaymentMethodToOrderUseCase)
    {
